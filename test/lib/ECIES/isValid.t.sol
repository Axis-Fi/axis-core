...
contract ECIESisValidTest is Test {
    // [ ] when the public key is not on the curve y^2 = x^3 + 3
    //      [ ] it returns false
    // [ ] when the public key is the generator point (1, 2)
    //      [ ] it returns false
    // [ ] when the public key is the point at infinity (0, 0)
    //      [ ] it returns false
    // [ ] when the public key x coordinate is greater than or equal to the field modulus
    //      [ ] it returns false
    // [ ] when the public key y coordinate is greater than or equal to the field modulus
    //      [ ] it returns false
    // [ ] when the public key is valid
    //      [ ] it returns true
