...
contract EmpaModuleClaimBidsTest is EmpaModuleTest {
        ...
        givenLotIsSettled
    {
        ...
        assertEq(bidClaimOne.refund, _BID_AMOUNT_UNSUCCESSFUL);
        ...
        assertEq(bidClaimTwo.refund, _BID_AMOUNT_UNSUCCESSFUL);
        ...
        givenLotHasStarted
    {
        ...
        assertEq(bidClaimOne.payout, 0);
        assertEq(bidClaimOne.refund, bidAmountIn);
        ...
        givenLotIsSettled
    {
        ...
        assertEq(bidClaimOne.payout, 0);
        assertEq(bidClaimOne.refund, _scaleQuoteTokenAmount(_BID_AMOUNT_UNSUCCESSFUL));
        ...
        assertEq(bidClaimTwo.payout, 0);
        assertEq(bidClaimTwo.refund, _scaleQuoteTokenAmount(_BID_AMOUNT_UNSUCCESSFUL));
        ...
        givenLotIsSettled
    {
        ...
        assertEq(bidClaims.length, 1, "bid claims length");
        ...
        Auction.Lot memory auctionLot = _getAuctionLot(_lotId);
        assertEq(
            auctionLot.claimableBidAmountOut, _scaleBaseTokenAmount(5e18), "claimableBidAmountOut"
        );
    }
    ...
    function test_givenLotHasPartialFill()
        external
        givenLotIsCreated
        givenLotHasStarted
    ...
    {
        // Marginal price is 2
        // Bids 1-2 are settled
        // Bid 3 is a partial fill (4 refunded, 2 payout)
        uint64 bidId = 3;
        ...
        assertEq(bidClaim.bidder, _BIDDER, "bidder");
        assertEq(bidClaim.referrer, _REFERRER, "referrer");
        assertEq(bidClaim.paid, _BID_AMOUNT, "paid");
        assertEq(bidClaim.payout, uint256(_BID_AMOUNT_OUT) * 1e18 / 2e18, "payout");
        assertEq(bidClaim.refund, uint256(_BID_AMOUNT) * 1e18 / 2e18, "refund");
        ...
        assertEq(
            auctionLot.claimableBidAmountOut,
            _scaleBaseTokenAmount(_BID_AMOUNT_OUT * 2),
            "claimableBidAmountOut"
        );
    }
}
