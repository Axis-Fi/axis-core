...
//     EMPAM.AuctionDataParams internal batchAuctionDataParams;
...
//         batchAuctionDataParams = EMPAM.AuctionDataParams({
//             minFillPercent: 1000,
//             minBidPercent: 1000,
//             minimumPrice: 1e18,
...
//     function _encrypt(EMPAM.Decrypt memory decrypt_)
//         internal
//         view
...
//         EMPAM.Decrypt memory decryptedBid =
//             EMPAM.Decrypt({amountOut: bidAmountOut_, seed: BID_SEED});
...
//         // Decrypt
//         EMPAM.Decrypt memory decryptedBid =
//             EMPAM.Decrypt({amountOut: BID_AMOUNT_OUT, seed: BID_SEED});
//         EMPAM.Decrypt[] memory decryptedBids =
//             new EMPAM.Decrypt[](1);
//         decryptedBids[0] = decryptedBid;

//         // Decrypt and sort bids
//         empam.decryptAndSortBids(lotId, decryptedBids);
...
//         Auctioneer.Routing memory routingData = catalogue.getRouting(lotId);
//         (Keycode auctionType,) = unwrapVeecode(routingData.auctionReference);
//         assertEq(fromKeycode(auctionType), "EMPAM", "auction type mismatch");
...
//         EMPAM.EncryptedBid memory bid =
//             empam.getBidData(lotId, bidId);
