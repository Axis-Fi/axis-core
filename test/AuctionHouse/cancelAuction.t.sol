...
contract CancelAuctionTest is AuctionHouseTest {
    ...
    // [X] given the auction is a batch
    ...
    function test_whenBatchAuction_givenCuratorIsSet()
        external
        whenAuctionTypeIsBatch
        whenBatchAuctionModuleIsInstalled
        givenSellerHasBaseTokenBalance(_LOT_CAPACITY)
    ...
    function test_whenBatchAuction_givenCuratorHasApproved()
        external
        whenAuctionTypeIsBatch
        whenBatchAuctionModuleIsInstalled
        givenSellerHasBaseTokenBalance(_LOT_CAPACITY)
