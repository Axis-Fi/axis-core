...
contract ClaimProceedsTest is AuctionHouseTest {
    ...
    //  [ ] it sends the proceeds to the auction seller
    // [ ] given the auction is pre-funded
    //  [ ] given the auction has curation enabled
    //   [ ] it sends the proceeds, unused capacity and unused curator fees to the auction seller
    //  [ ] it sends the proceeds and unused capacity to the auction seller
